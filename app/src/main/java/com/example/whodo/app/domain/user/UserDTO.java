...
public class UserDTO {
    ...
    public UserDTO() {} // Constructor vacío requerido por MongoDB

    public UserDTO(String id, String authId, String address, Date birthday, Date createDate, Date deleteDate,
